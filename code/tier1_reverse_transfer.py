...
# Data paths (all vendored into this project)
WHOI_DIR = Path(DATA["whoi22"])
ZOOSCAN_DIR = Path(DATA["zooscan20"])
ZOOlAKE_DIR = Path(DATA["zoolake2"])

# DataShift cross-instrument data (has overlapping classes)
DS_IFCB = Path(DATA["cross_ifcb"])
DS_ZOOSCAN = Path(DATA["cross_zooscan"])
