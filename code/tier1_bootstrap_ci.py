...
def main():
    ...
    fourier_path = ROOT / "results" / "adverserial_net" / "fourier_analysis_zoolake2" / "fourier_analysis.json"
    ...
    cross_domain_files = {
        "ViT_standard": ROOT / "results" / "adverserial_net" / "baselines_cross_instrument.json",
        "SBA_spectral_noise": ROOT / "results" / "adverserial_net" / "saa_noise_v2.json",
        "SBA_band_adv": ROOT / "results" / "adverserial_net" / "saa_band_v2.json",
        "SBA_band_TTA": ROOT / "results" / "adverserial_net" / "ens_saa_band_tta_seed42.json",
    }
    ...
    ood_files = {
        "DataShift-ZooScan": ROOT / "results" / "adverserial_net" / "ood_detection" / "ood_detection_results.json",
        "ZooLake2": ROOT / "results" / "adverserial_net" / "ood_detection_zoolake2" / "ood_detection_results.json",
    }
